...
function OrderRoute(){
    ...
    async function fetch(){
        ...
        await axios.get(`http://localhost:3001/getOrders/pending`).then((value)=>{
                    ...
                    <table>
                       ...
                       
                       {
                            ...
                            order.map((value)=>(
                                ...
                                <td><button onClick={()=>Process(value['order_id'], "confirm", value['user'])}>Accept</button></td>
                            </tr>
